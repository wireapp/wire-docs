...
* Various Spar fixes, breaking changes, refactorings, and what-not. Please
  ...
  80d06c9a.
* Spar now only accepts a [subset](https://hackage.haskell.org/package/tls-1.4.1/docs/src/Network-TLS-Extra-Cipher.html#ciphersuite_default) of available TLS
